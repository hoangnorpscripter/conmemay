...
elseif id == 7449423635 then
    ...
    game:GetService("Players").LocalPlayer.kick("Đéo Support")
end
...
function TweenShip(CFgo)
    ...
    tween =
        tween_s:Create(
        game:GetService("Workspace").Boats.MarineBrigade.VehicleSeat,
        info,
        {
            CFrame = CFgo
        }
    ...
    function()
        while task.wait() do
            pcall(
                function()
                    if
                        _G.TeleportIsland or _G.AutoEvoRace or AutoFarmChest or _G.chestsea2 or _G.chestsea3 or
                            _G.CastleRaid or
                            _G.CollectAzure or
        ...
        pcall(
            function()
                game:GetService("RunService").Stepped:Connect(
                    function()
                        if
                            _G.TeleportIsland or _G.AutoEvoRace or _G.CastleRaid or AutoFarmChest or _G.CollectAzure or
                                _G.TweenToKitsune or
                                _G.AutoCandy or
                                _G.GhostShip or
                                _G.Ship or
...
local Section = Tabs.Main:AddSection("Auto Katakuri")

local katav1 = Tabs.Main:AddToggle("Auto Katakuri",
    {
        Title = "Auto Katakuri",
...
local SpawnKata = Tabs.Main:AddToggle("spawnkatav1",
    {
        Title = "Auto Spawn Katakuri",
        Description = "Auto Spawn Katakuri",
        Default = true
    }
)
                ...
                if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
                    if BypassTP then
                        if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - BoneCFrame2.Position).Magnitude >
                            2500 then
                            to(BoneCFrame2)
                        elseif (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - BoneCFrame.Position).Magnitude <
                            2500 then
                            Tween(BoneCFrame)
                        end
                    else
                    ...
                    if (BoneCFrame.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <=
                        3 then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StartQuest", "HauntedQuest2",
                            1)
                    end
